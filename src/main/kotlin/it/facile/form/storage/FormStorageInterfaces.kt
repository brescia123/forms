...
interface FormStorageApi {
    ...
    fun ping(key: String, executeActions: Boolean = false)
    ...
    fun putValue(key: String, value: FieldValue, executeActions: Boolean = false)

    fun disable(key: String, executeActions: Boolean = false)

    fun enable(key: String, executeActions: Boolean = false)

    /** Clear the selected value for the given key and notify the change */
    fun clearValue(key: String, executeActions: Boolean = false)
    ...
    fun setVisibility(key: String, hidden: Boolean, executeActions: Boolean = false)
    ...
    fun putPossibleValues(key: String, possibleValues: FieldPossibleValues, executeActions: Boolean = false)
    ...
    fun switchPossibleValues(key: String, possibleValues: FieldPossibleValues, executeActions: Boolean = false)
    ...
    fun putValueAndSetVisibility(key: String, value: FieldValue, hidden: Boolean, executeActions: Boolean = false)

    /** Clear possible values for the given key and and
     * notify the change
     * If at the given key there are no possible values it does nothing. */
    fun clearPossibleValues(key: String, executeActions: Boolean = false)
